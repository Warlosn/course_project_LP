...
#define TI_CYMBDEFAULT	0x00		//значение по умолчанию дл€ типа string
#define TI_NULLIDX		0xffffffff	//нет элемента таблицы идентификаторов
#define TI_CYMB_MAXSIZE	225	

namespace IT
{
	enum IDDATATYPE { NUM = 1, CYMB = 2,  CHAR=3 };
	...
	struct Entry
	{
		...
		union
		{
			...
			struct {
				...
				char str[TI_CYMB_MAXSIZE];		//символы string
