...
namespace Error
{
	...
	{
		ERROR_ENTRY(0, "[SYSTEM]: Íåäîïóñòèìûé êîä îøèáêè"), // êîä îøèáêè âíå äèàïàçîíà 0 - ERROR_MAX_ENTRY
		...
		ERROR_ENTRY(114, "[IN]: Îòñóñòâóåò çàêğûâàşùàÿ êàâû÷êà"),//+
		ERROR_ENTRY_NODEF(115), ERROR_ENTRY_NODEF(116),	ERROR_ENTRY_NODEF(117),
		ERROR_ENTRY_NODEF(118), ERROR_ENTRY_NODEF(119),

		ERROR_ENTRY(120, "[LA]: Îøèáêà ïğè ğàçáîğå òîêåíà"),
		ERROR_ENTRY(121, "[LA]: Èñïîëüçóåòñÿ íåîáúÿâëåííûé èäåíòèôèêàòîğ"),
		ERROR_ENTRY(122, "[LA]: Ïåğåïîëíåíèå òàáëèöû èäåíòèôèêàòîğîâ"),
		ERROR_ENTRY(123, "[LA]: Ïåğåïîëíåíèå òàáëèöû ëåêñåì"),
		ERROR_ENTRY(124, "[LA]: Îòñóòñòâóåò òî÷êà âõîäà"),
		ERROR_ENTRY(125, "[LA]: Îáíàğóæåíî íåñêîëüêî òî÷åê âõîäà"),
		...
		ERROR_ENTRY(600, "[SA]: Íåâåğíàÿ ñòğóêòóğà ïğîãğàììû"),
		ERROR_ENTRY(601, "[SA]: Îøèáî÷íûé îïåğàòîğ"),
		ERROR_ENTRY(602, "[SA]: Îøèáêà â âûğàæåíèè"),
		ERROR_ENTRY(603, "[SA]: Îøèáêà â ïàğàìåòğàõ ôóíêöèè"),
		ERROR_ENTRY(604, "[SA]: Îøèáêà â ïàğàìåòğàõ âûçûâàåìîé ôóíêöèè"),
		ERROR_ENTRY(605, "[SA]: Îøèáêà çíàêà â âûğàæåíèè"),
		ERROR_ENTRY(606, "[SA]: Îøèáêà â ñèíòàêñè÷åñêîì àíàëèçå"),
		ERROR_ENTRY(607, "[SA]: Îøèáêà â ëèòåğàëå"),
		ERROR_ENTRY_NODEF(608),
		ERROR_ENTRY(609, "[SA]: Îáíàğóæåíà ñèíòàêñè÷åñêàÿ îøèáêà(ñìîòğè æóğíàë Log)"),
		...
		ERROR_ENTRY(704, "[SemA]: Òèï äàííûõ ğåçóëüòàòà âûğàæåíèÿ íå ñîîòâåòñòâóåò ïğèñâàèâàåìóìó èäåíòèôèêàòîğó"),//+
